...
def test_GeneticAlgorithmAndLogisticVirtual():
    ...
    # build a simple deck
    deck = [Expression("v[0]",0),Expression("c[0]",1),Expression("1",0),Expression("10",0),Expression("100",0),Expression("1000",0)]

    # create range objects
    const_range = Range(0,100)

    # Start the Genetic Algorithm
    final_generation = GeneticAlgorithm(20, interfaces, current_generation, 1, 2, 10, 0.2, const_range, deck, 100, 10, 1000, 0.1)
